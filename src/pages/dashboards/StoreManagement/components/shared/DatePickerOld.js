      ...
      <Box sx={{ position: "relative" }}>
        <div className={classes.analyticsContainer}>
            ...
            <OutlinedInput
              ...
              startAdornment={
                <InputAdornment position="start">
                  <CalendarTodayIcon sx={{ color: disabled && "#bcbcbd" }} />
                </InputAdornment>
              }
            />
          </FormControl>
          <p className={classes.pContainer}>
            {checked
              ? comparedActivityRange
                ? `compared to ${comparedActivityRange}`
                : null
              : defaultDates.compareStartDate && defaultDates.compareEndDate
              ? `compared to ${defaultDates.compareStartDate} - ${defaultDates.compareEndDate}`
              : null}
          </p>
        </div>
        {open ? (
